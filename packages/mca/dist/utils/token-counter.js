...
export class TokenCounter {
     ...
     */
    static estimateObjectTokens(obj) {
     ...
     */
    static estimateCost(tokens, model = 'mistral') {
        ...
        return tokens * (costPerToken[model] || costPerToken['mistral']);
    }
    /**
